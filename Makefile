...
# check in contracts/script/output/${CHAINID}/trappist_avs_deployment_output.json
...
deploy-trappist-contracts:
						@chmod +x ./contracts/anvil/deploy-trappist.sh
						./contracts/anvil/deploy-trappist.sh
