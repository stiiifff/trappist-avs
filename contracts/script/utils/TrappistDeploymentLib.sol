...
library TrappistDeploymentLib {
    ...
    function readDeploymentJson(
        ...
        require(vm.exists(fileName), "trappistDeployment: Deployment file does not exist");
    ...
    function writeDeploymentJson(
        ...
        writeDeploymentJson("deployments/trappist/", block.chainid, data);
    }
    ...
    function readDeploymentConfigValues(
        ...
        require(vm.exists(pathToFile), "trappistDeployment: Deployment Config file does not exist");
